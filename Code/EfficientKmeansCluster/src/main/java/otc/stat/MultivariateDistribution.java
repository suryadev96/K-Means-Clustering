...
public interface MultivariateDistribution {
	...
	/**
	 * The probability density function for continuous distribution or probability
	 * mass function for discrete distribution at x.
	 */
	 ...
	 *
	 * @param x
	 *            sample set. Each row is a sample.
	 */
