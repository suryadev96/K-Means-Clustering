...
public class QuickSort {
	...
	/**
	 * Besides sorting the array arr, the array brr will be also rearranged as the
	 * same order of arr.
	 */
	 ...
	 * Besides sorting the first n elements of array arr, the first n elements of
	 * array brr will be also rearranged as the same order of arr.
	 */
