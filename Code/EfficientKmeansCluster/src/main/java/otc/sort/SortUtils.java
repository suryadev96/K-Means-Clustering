...
public class SortUtils {
	 ...
	 * postion k/2) if necessary, continuing as long as a[k/2] &lt; a[k] or until we
	 ...
	 * move down the heap, exchanging the node at position k with the larger of that
	 * node's two children if necessary and stopping when the node at k is not
	 * smaller than either child or the bottom is reached. Note that if n is even
	 * and k is n/2, then the node at k has only one child -- this case must be
	 * treated properly.
	 */
