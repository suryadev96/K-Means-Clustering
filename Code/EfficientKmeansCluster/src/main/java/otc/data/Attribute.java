...
public abstract class Attribute implements Serializable {
	...
	public enum Type {
		 ...
		 * attribute because one may use some part of strings (e.g. suffix or prefix)
		 * instead of the original string as features.
		 */
		STRING,
		/**
		 * Date attribute. A date type also optionally specifies the format in which the
		 * date is presented, with the default being in ISO-8601 format.
		 */
		DATE
	}
	 ...
	 * Although there are on explicit requirements on the weights, in general, they
	 * should be positive.
	 */
	 ...
	 * 
	 * @param x
	 *            a double value of this attribute. NaN means missing value.
	 ...
	 * 
	 * @param s
	 *            a string value of this attribute.
	 */
