...
public class NominalAttribute extends Attribute {
	...
	/**
	 * True if the string values of the nominal attribute is a open set. The new
	 * string values will be added into the attribute when calling the method
	 * valueOf(String).
	 */
	 ...
	 *            the name of attribute.
	 * @param description
	 *            the detailed description of attribute.
	 */
	...
	/**
	 * Returns true if the string values of the nominal attribute is a open set. The
	 * new string values will be added into the attribute when calling the method
	 * valueOf(String).
	 * 
