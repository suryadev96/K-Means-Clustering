...
public class Dataset<E> implements Iterable<Datum<E>> {
	...
	/**
	 * Returns the response attribute vector. null means no response variable in
	 * this dataset.
	 * 
	 * @return the response attribute vector. null means no response variable in
	 *         this dataset.
	 */
	 ...
	 *            the class label of the datum.
	 * @param weight
	 *            the weight of datum. The particular meaning of weight depends on
	 *            applications and machine learning algorithms. Although there are
	 *            on explicit requirements on the weights, in general, they should
	 *            be positive.
	 * @return the added datum item.
	 */
	public Datum<E> add(E x, int y, double weight) {
		...
		return add(new Datum<E>(x, y, weight));
	}
	...
	/**
	 * Returns an array containing all of the elements in this dataset in proper
	 * sequence (from first to last element); the runtime type of the returned array
	 * is that of the specified array. If the dataset fits in the specified array,
	 * it is returned therein. Otherwise, a new array is allocated with the runtime
	 * type of the specified array and the size of this dataset.
	 * <p>
	 ...
	 * 
	 * @param a
	 *            the array into which the elements of this dataset are to be
	...
	/**
	 * Returns an array containing the class labels of the elements in this dataset
	 * in proper sequence (from first to last element). Unknown labels will be saved
	 * as Integer.MIN_VALUE. If the dataset fits in the specified array, it is
	 * returned therein. Otherwise, a new array is allocated with the size of this
	 * dataset.
	 * <p>
	 * If the dataset fits in the specified array with room to spare (i.e., the
	 * array has more elements than the dataset), the element in the array
	 ...
	 * 
	 * @param a
	 *            the array into which the class labels of this dataset are to be
	 ...
	 * dataset in proper sequence (from first to last element). If the dataset fits
	 * in the specified array, it is returned therein. Otherwise, a new array is
	 * allocated with the size of this dataset.
	 * <p>
	 * If the dataset fits in the specified array with room to spare (i.e., the
	 * array has more elements than the dataset), the element in the array
	 ...
	 * 
	 * @param a
	 *            the array into which the response variable of this dataset are to
	...
	/**
	 * Returns an array containing the string names of the elements in this dataset
	 * in proper sequence (from first to last element). If the dataset fits in the
	 * specified array, it is returned therein. Otherwise, a new array is allocated
	 * with the size of this dataset.
	 * <p>
	 * If the dataset fits in the specified array with room to spare (i.e., the
	 * array has more elements than the dataset), the element in the array
	 * immediately following the end of the dataset is set to null.
	 ...
	 *            dataset are to be stored, if it is big enough; otherwise, a new
	...
	/**
	 * Returns an array containing the timestamps of the elements in this dataset in
	 * proper sequence (from first to last element). If the dataset fits in the
	 * specified array, it is returned therein. Otherwise, a new array is allocated
	 * with the size of this dataset.
	 * <p>
	 * If the dataset fits in the specified array with room to spare (i.e., the
